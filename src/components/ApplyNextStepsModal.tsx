  ...
  return (
    ...
    >
      <div className="relative w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
        ...
        <div className="pr-8">
          <p className="text-sm font-semibold text-accent-600">Application submitted</p>
          <h2
          ...
          <p className="mt-2 text-sm leading-relaxed text-ink-500">
            Would you like help tailoring your resume or preparing a cover letter?
          </p>
        </div>
        ...
        <div className="mt-6 grid gap-3">
          ...
          >
            ...
            <span>
              ...
              <span className="block text-xs text-ink-500">Improve your resume for this role.</span>
            </span>
          </Link>
          ...
          >
            ...
            <span>
              ...
              <span className="block text-xs text-ink-500">Prepare a tailored cover letter.</span>
            </span>
          </Link>
        </div>
